...
interface InputProps extends React.InputHTMLAttributes<HTMLInputElement> {
  endEnhancer?: React.ReactElement | string;   // string = online image URL
  error?: string;
  handleInputRef?: (ref: Nullable<HTMLInputElement>) => void;
  index?: number;
  startEnhancer?: React.ReactElement | string; // string = online image URL
  testId?: string;
  textAlign?: 'left' | 'center' | 'right';
  type?: string;
}

const renderEnhancer = (enhancer: React.ReactElement | string) => {
