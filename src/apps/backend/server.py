...
from modules.chatbot.chatbot_rest_api_server import ChatbotRestApiServer
...
# Register chatbot apis
chatbot_blueprint = ChatbotRestApiServer.create()
api_blueprint.register_blueprint(chatbot_blueprint)
